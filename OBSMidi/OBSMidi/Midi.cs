...
namespace OBSMidi
{
    ...
    class Midi
    {
        ...
        private void OnOBSStreamStopped(object sender, OBSConnector.OBSEventArgs e)
        {
            this.LEDStatus(41, false);
        }

        private void OnOBSStreamStarted(object sender, OBSConnector.OBSEventArgs e)
        {
            this.LEDStatus(41, true);
        }

        private void OnOBSReplayStopped(object sender, OBSConnector.OBSEventArgs e)
        {
            this.LEDStatus(45, false);
        }

        private void OnOBSReplayStarted(object sender, OBSConnector.OBSEventArgs e)
        {
